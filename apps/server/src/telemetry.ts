...
class ServerMetrics {
  ...
  private ensureInitialized() {
    if (!this.requestCounter && telemetry) {
      this.requestCounter = telemetry.meter.createCounter(
      ...
      this.requestDuration = telemetry.meter.createHistogram(
      ...
      this.activeRequests = telemetry.meter.createUpDownCounter(
